...
import { ArrowLeft, ShoppingCart, Search, Terminal, Plus, Minus, Trash2, Camera } from 'lucide-react'
                    ...
                    <header className="h-16 flex items-center justify-between px-4 bg-white dark:bg-zinc-900 border-b border-slate-200 dark:border-zinc-800 shrink-0">
                        ...
                        <div className="relative max-w-sm w-full hidden md:block">
                            ...
                            <input
                                ...
                                className="w-full h-9 pl-9 pr-10 rounded-full bg-slate-100 dark:bg-zinc-800 border-transparent focus:border-primary focus:ring-1 focus:ring-primary text-sm outline-none transition-all"
                            />
                            <button
